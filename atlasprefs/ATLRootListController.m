...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.headerImageView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/atlasprefs.bundle/iconSquare.png"];
		...
		[self.headerImageView anchorTop:nil
						 leading:self.headerView.leadingAnchor
						 bottom:nil
						 trailing:nil
						 padding:UIEdgeInsetsMake(0,40,0,0)
						 size:CGSizeMake(80,80)];
		[self.headerImageView.centerYAnchor constraintEqualToAnchor:self.headerView.centerYAnchor].active = YES;

		[self.headerLabel anchorTop:self.headerImageView.topAnchor
						 leading:nil
						 bottom:nil
						 trailing:self.headerView.trailingAnchor
						 padding:UIEdgeInsetsMake(4,10,0,10)
						 size:CGSizeMake(150,50)];
		// [self.headerLabel.centerYAnchor constraintEqualToAnchor:self.headerView.centerYAnchor].active = YES;

		[version anchorTop:self.headerLabel.bottomAnchor
